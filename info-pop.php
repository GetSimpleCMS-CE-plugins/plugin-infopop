...
echo'<img src="'.$SITEURL.'/plugins/info-pop/img/close.svg" class="toper-close" style="width:24px;filter:invert(100%);">'.file_get_contents('data/other/bulb/content.txt', true);
echo '</div>';
...
echo'<label for="width">width</label><input name="width" type="input" value="'.@file_get_contents('../data/other/bulb/width.txt').'">';
    ...
    echo '
    <form action="https://www.paypal.com/cgi-bin/webscr"   method="post" target="_top" style="display:flex;flex-direction:column;gap:10px;border:solid 1px #ddd;padding:10px;box-sizing:border-box; width:100%;align-items:center;justify-content:space-between;background:#fafafa;color:black;">
            <p style="margin:0;padding:0;">Support my work:)</p>
